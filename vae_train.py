...
from models.beta_vae import BetaVAE_H, normal_init
from utils.vae_data_loader import return_data
...
class Solver(object):
    def __init__(self, max_iter = 500000, data_loader = return_data(), load_ckpt=None):
        self.global_iter = 0
